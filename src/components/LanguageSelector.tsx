        ...
        projects: [
          {
            ...
            longDescription: 'Մենք նախագծել և մշակել ենք ժամանակակից էլեկտրոնային առևտրի հարթակ, որը թույլ է տալիս հեշտությ
ամբ դիտել ապրանքները, կատարել ընդլայնված զտում և ունի պարզեցված վճարման գործընթաց: Հարթակը ներառում է պահեստի կառավարում, պատվերների հետևում և վերլուծական վահանակներ հաճախորդի համար:',
            features: [
              'Հարմարեցվող դիզայն բոլոր սարքերի համար',
